...
import { Modal, Form, Button, Alert, Spinner, InputGroup, Row, Col } from 'react-bootstrap';
  ...
  const handleProjectManagerSearch = (e) => {
    ...
    setFilteredProjectManagers(
      projectManagers.filter(pm => 
        `${pm.firstName} ${pm.lastName}`.toLowerCase().includes(searchTerm.toLowerCase())
      )
    );
  };
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3" ref={customerDropdownRef}>
            ...
            {showCustomerDropdown && (
              <div className="position-absolute bg-white shadow-sm rounded mt-1" style={{ zIndex: 1000, width: '95%', maxHeight: '200px', overflowY: 'auto' }}>
